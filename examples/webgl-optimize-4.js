...
function setMvMatrix(sp) {
  ...
  sp.x_offset = (currentCos * sp.x_offset_orig);
  sp.y_offset = (currentSin * sp.y_offset_orig);
  sp.z_offset = -25.0 + 12.0 * currentSin;
}

function drawScene() {
  currentCos = Math.cos(angle);
  currentSin = Math.sin(angle);
  angle += 0.05;
